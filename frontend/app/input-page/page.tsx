...
const promptTemplate = new PromptTemplate({
  inputVariables: ["copiedText"],
  template: `Analyze the copied text of a web page below and generate a description of the page.
  ...
  I want this description to help this page to rank better on search engines.Using this {copiedText} of products give me a what type of product it is
  {copiedText}`,
})
...
export default function Home() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    setIsLoading(true);
    const llmResponse = await chain.call({ copiedText: copiedText });
